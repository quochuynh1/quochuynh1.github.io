...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px; margin-top: 12px;">
  ...
  <a href="/images/millingmachine/board.png"><img src="/images/millingmachine/board.png" alt="Example control code" style="width: 100%; border-radius: 6px; object-fit: cover; aspect-ratio: 4/3;"></a>
